...
<Section title="System Contracts">
    ...
    | :--- | :--- | :--- |
    | <Copy value="0x4200000000000000000000000000000000000006" label="0x420...06" /> | <Reference label="WETH9" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/vendor/WETH9.sol" /> | The standard implementation of Wrapped Ether on Base |
    ...
    | <Copy value="0x4200000000000000000000000000000000000010" label="0x420...10" /> | <Reference label="L2StandardBridge" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/L2/L2StandardBridge.sol" /> | Provides a higher level API built on top of the `L2CrossDomainMessenger` that gives standard interface for sending ETH or ERC20 across domains |
    ...
    | <Copy value="0x4200000000000000000000000000000000000014" label="0x420...14" /> | <Reference label="L2ERC721Bridge" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/L2/L2ERC721Bridge.sol" /> | The L2 ERC721 bridge is a contract which works together with the L1 ERC721 bridge to make it possible to transfer ERC721 tokens from Ethereum to Optimism |
    | <Copy value="0x4200000000000000000000000000000000000015" label="0x420...15" /> | <Reference label="L1Block" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/L2/L1Block.sol" /> | Responsible for maintaining L1 context in L2. This allows for L1 state to be accessed in L2 |
    ...
    | <Copy value="0x4200000000000000000000000000000000000017" label="0x420...017" /> | <Reference label="OptimismMintableERC721Factory" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/universal/OptimismMintableERC721Factory.sol" /> | Responsible for creating ERC721 contracts on L2 that can be used for depositing native L1 NFTs into |
    | <Copy value="0x4200000000000000000000000000000000000018" label="0x420...018" /> | <Reference label="ProxyAdmin" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/universal/ProxyAdmin.sol" /> | Owner of all of the proxy contracts set at the predeploys. It is itself behind a proxy. The owner of the ProxyAdmin will have the ability to upgrade any of the other predeploy contracts |
    | <Copy value="0x4200000000000000000000000000000000000019" label="0x420...019" /> | <Reference label="BaseFeeVault" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/L2/BaseFeeVault.sol" /> | Receives the basefees on L2. The basefee is not burnt on L2 like it is on L1. Once the contract has received a certain amount of fees, the ETH can be withdrawn to an immutable address on L1 |
