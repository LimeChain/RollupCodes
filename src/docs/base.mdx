    ...
    <MultiRowParameters title="Messaging" tooltip="The Rollup provides native communication with L1. Anyone is able to transmit arbitrary messages and the Base protocol will provide proof of the data transfer on the destination chain" data={[
        {
            ...
            rows: [
                ...
                {
                    label: 'Cost',
                    tooltip: 'The gas cost of sending a message from Ethereum to the L2. Base executes the message with a system address on behalf of the L1 sender. The initial 1.92m gas is free of charge. All gas in excess of 1.92m is paid by the sender of the message on L1.',
                    value: 'Free*',
                },
            ],
        },
...
<Section title="System Contracts">
    ...
    | <Copy value="0x4200000000000000000000000000000000000014" label="0x420...14" /> | <Reference label="L2ERC721Bridge" url="https://github.com/ethereum-optimism/optimism/blob/master/packages/contracts-bedrock/contracts/L2/L2ERC721Bridge.sol" /> | Responsible for maintaining L1 context in L2. This allows for L1 state to be accessed in L2 |
