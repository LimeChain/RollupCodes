...
<Section title="Overview">
   Base is an Optimistic Rollup utilizing OP Stack technology. The protocol features a centralised sequencer operated by the Base team. Fraud proofs have yet to be enabled on the platform.
    ...
    - Contribute to the Research and Development of the Optimism SuperChain, the goal of which is to enable superior interoperability and aligned crypto-economic incentives for a shared validator set between all OP-based rollups.
