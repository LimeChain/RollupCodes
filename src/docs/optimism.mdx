...
<Section title="System Contracts">
    ...
    | :--- | :--- | :--- |
    | <Copy value="0x4200000000000000000000000000000000000006" label="0x420...06" /> | [WETH9](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/vendor/WETH9.sol) | The standard implementation of Wrapped Ether on Optimism |
    | <Copy value="0x4200000000000000000000000000000000000007" label="0x420...07" /> | [L2CrossDomainMessenger](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L2CrossDomainMessenger.sol) | Provides a higher level API for sending cross-domain messages compared to directly calling the `L2ToL1MessagePasser`. Allows for replayability if the L1 to L2 transaction reverts on L2  |
    | <Copy value="0x4200000000000000000000000000000000000010" label="0x420...10" /> | [L2StandardBridge](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L2StandardBridge.sol) | Provides a higher level API built on top of the `L2CrossDomainMessenger` that gives standard interface for sending ETH or ERC20 across domains |
    | <Copy value="0x4200000000000000000000000000000000000011" label="0x420...11" /> | [SequencerFeeVault](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/SequencerFeeVault.sol) | Accumulates any transaction priority fee and is the value of `block.coinbase`. When enough fees accumulate in this account, they can be withdrawn to an immutable L1 address |
    | <Copy value="0x4200000000000000000000000000000000000012" label="0x420...12" /> | [OptimismMintableERC20Factory](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/universal/OptimismMintableERC20Factory.sol) | Responsible for creating ERC20 contracts on L2 that can be used for depositing native L1 tokens into. These ERC20 contracts can be created permisionlessly and implement the interface required by the `StandardBridge` to just work with deposits and withdrawals |
    | <Copy value="0x420000000000000000000000000000000000000F" label="0x420...0F" /> | [GasPriceOracle](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/GasPriceOracle.sol) | Provides information of L1 base fee data and calculates the L1 fee  for a given transaction |
    | <Copy value="0x4200000000000000000000000000000000000042" label="0x420...42" /> | GovernanceToken | The Optimism OP governance token. |
    | <Copy value="0x4200000000000000000000000000000000000015" label="0x420...15" /> | [L1Block](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L1Block.sol) | Responsible for maintaining L1 context in L2. This allows for L1 state to be accessed in L2 |
    | <Copy value="0x4200000000000000000000000000000000000016" label="0x420...16" /> | [L2ToL1MessagePasser](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L2ToL1MessagePasser.sol) | Stores commitments to withdrawal transactions. When a user is submitting the withdrawing transaction on L1, they provide a proof that the transaction that they withdrew on L2 is in the `sentMessages` mapping of this contract |
    | <Copy value="0x4200000000000000000000000000000000000017" label="0x420...017" /> | [OptimismMintableERC721Factory](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/universal/OptimismMintableERC721Factory.sol) | Responsible for creating ERC721 contracts on L2 that can be used for depositing native L1 NFTs into |
    | <Copy value="0x4200000000000000000000000000000000000018" label="0x420...018" /> | [ProxyAdmin](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/universal/ProxyAdmin.sol) | Owner of all of the proxy contracts set at the predeploys. It is itself behind a proxy. The owner of the ProxyAdmin will have the ability to upgrade any of the other predeploy contracts |
    | <Copy value="0x4200000000000000000000000000000000000019" label="0x420...019" /> | [BaseFeeVault](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/BaseFeeVault.sol) | Receives the basefees on L2. The basefee is not burnt on L2 like it is on L1. Once the contract has received a certain amount of fees, the ETH can be withdrawn to an immutable address on L1 |
    | <Copy value="0x420000000000000000000000000000000000001a" label="0x420...01a" /> | [L1FeeVault](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L1FeeVault.sol) | Receives the L1 portion of the transaction fees. Once the contract has received a certain amount of fees, the ETH can be withdrawn to an immutable address on L1 |
