...
<Section title="General">
    ...
    <Parameter name="Rollup’s State Contract on L1" value={<Reference label="0x6A1DB7d799FBA381F2a518cA859ED30cB8E1d41a" url="https://etherscan.io/address/0x6A1DB7d799FBA381F2a518cA859ED30cB8E1d41a" />} tooltip="The contract used for sequencing, proving and storing the state of the L2 network" />
