...
<Section title="General">
    ...
    <Parameter name="Node Implementations" value={[<Reference label="op-geth (Go)" url="https://github.com/ethereum-optimism/op-geth" />, <Reference label="op-erigon (Go)" url="https://github.com/testinprod-io/op-erigon" />, <Reference label="magi (Rust)" url="https://github.com/a16z/magi" />]} tooltip="The different client implementations of the Rollup" />
