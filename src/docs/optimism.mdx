...
<Section title="System Contracts">
    ...
    | Address | Name | Rollup Behaviour | Ethereum L1 Behaviour |
    | :--- | :--- | :--- | :--- |
    | <Copy value="0x4200000000000000000000000000000000000006" label="0x420...06" /> | <Reference label="WETH9" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/vendor/WETH9.sol" /> | The standard implementation of Wrapped Ether on Base | N/A <Added /> |
    ...
    | <Copy value="0x4200000000000000000000000000000000000010" label="0x420...10" /> | <Reference label="L2StandardBridge" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L2StandardBridge.sol" /> | Provides a higher level API built on top of the `L2CrossDomainMessenger` that gives standard interface for sending ETH or ERC20 across domains | N/A <Added /> |
    ...
    | <Copy value="0x4200000000000000000000000000000000000015" label="0x420...15" /> | <Reference label="L1Block" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/contracts/L2/L1Block.sol" /> | Responsible for maintaining L1 context in L2. This allows for L1 state to be accessed in L2 | N/A <Added /> |
