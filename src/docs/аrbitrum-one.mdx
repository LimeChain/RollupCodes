---
title: Arbitrum One
subtitle: Arbitrum is an Optimistic Rollup which provides EVM compatibility. The protocol team centrally operates the sequencer. Fraud proofs are enabled for whitelisted validators. The network focuses on developing support for non-EVM-based contracts (EVM+), although they are not yet in production.
labels:
    - Optimistic Rollup
    - EVM
    - Mainnet
...
<Section title="Overview">
    ...
    Arbitrum is an Optimistic Rollup which provides EVM compatibility. The protocol team centrally operates the sequencer. Fraud proofs are enabled for whitelisted validators. The network focuses on developing support for non-EVM-based contracts (EVM+), although they are not yet in production.
