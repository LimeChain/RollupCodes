...
<Section title="Overview">
   World Chain is an Optimistic Rollup utilizing OP Stack technology and made for humans, where the transactions of unique humans have priority and where they also have a free allowance, just for being a World ID verified unique human using proof of personhood. The protocol features a centralised sequencer operated by the World Chain team.
    ...
    <MultiRowParameters title="Messaging" tooltip="The Rollup provides native communication with L1. Anyone is able to transmit arbitrary messages and the World Chain protocol will provide proof of the data transfer on the destination chain" data={[
        ...
        },
        {
            ...
            rows: [
                {
                    label: 'Latency',
                    tooltip: 'The time it takes for a message to be made available on Ethereum after being included in an World Chain block and sequenced to L1.',
                    value: '7 days',
                },
                {
                    label: 'Cost',
