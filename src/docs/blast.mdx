...
<Section title="Overview">
   Blast is an EVM-compatible, optimistic rollup utilizing the OP Stack that raises the baseline yield for users and developers without changing the experience cryptonatives expect.
...
<Section title="General">
    ...
    <Parameter name="Sequencing Frequency" value="~20 minutes" tooltip="The frequency at which the rollup posts L2 transactions on Ethereum L1. The time varies based on the amount of calldata that must be posted on L1" />
...
<Section title="System Contracts">
    ...
    | <Copy value="0x4200000000000000000000000000000000000006" label="0x420...006" /> | <Reference label="WETH" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/WETH.sol" /> | The standard implementation of Wrapped Ether on Blast | N/A <Added /> |
    | <Copy value="0x4200000000000000000000000000000000000007" label="0x420...007" /> | <Reference label="L2CrossDomainMessenger" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/L2CrossDomainMessenger.sol" />| Provides a higher level API for sending cross-domain messages compared to directly calling the `L2ToL1MessagePasser`. Allows for replayability if the L1 to L2 transaction reverts on L2 | N/A <Added /> |
    | <Copy value="0x4200000000000000000000000000000000000010" label="0x420...010" /> | <Reference label="L2StandardBridge" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/L2StandardBridge.sol" /> | Provides a higher level API built on top of the `L2CrossDomainMessenger` that gives standard interface for sending ETH or ERC20 across domains | N/A <Added /> |
    | <Copy value="0x4200000000000000000000000000000000000011" label="0x420...011" /> | <Reference label="SequencerFeeVault" url="https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-bedrock/src/L2/SequencerFeeVault.sol" /> | Accumulates any transaction priority fee and is the value of `block.coinbase`. When enough fees accumulate in this account, they can be withdrawn to an immutable L1 address | N/A <Added /> |
    ...
    | <Copy value="0x4300000000000000000000000000000000000002" label="0x430...002" /> | <Reference label="Blast" url="https://github.com/blast-io/blast/blob/master/blast-optimism/packages/contracts-bedrock/src/L2/Blast.sol" /> | Used for configuring yield and gas fees mode for smart contracts | N/A <Added /> |
