...
<Section title="Overview">
   ...
   Taiko aims to be a Based and Type1 (Ethereum-equivalent) ZK-Rollup with decentralized and permissionless sequencers and provers. It uses tiered multi-proofs system. Currently the protocol uses SGX proofs (lowest tier proofs) which makes it an Optimistic Rollup. Higher proof tiers such as the zkEVM circuits are not yet enabled in production.
