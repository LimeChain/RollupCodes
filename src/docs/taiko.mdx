    ...
    <MultiRowParameters title="Messaging" tooltip="The Rollup provides native communication with L1. Anyone is able to transmit arbitrary messages and the Taiko protocol will provide proof of the data transfer on the destination chain" data={[
        ...
        },
        {
            ...
            rows: [
                {
                    label: 'Latency',
                    tooltip: 'The maximum time it takes for a message to be made available on Ethereum after being included in an Taiko block, a validity proof is generated and passed to L1.',
                    value: '90 minutes',
                },
                {
                    label: 'Cost',
...
<Section title="OPCODEs">
    ...
    | 48 | BASEFEE | `block.basefee` | Returns `1` (wei) | Returns the base fee <Modified />  |
