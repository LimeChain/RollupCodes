---
title: Taiko
subtitle: Taiko is a decentralized ZK-Rollup that is still in development. The protocol targets Type 1 EVM compatibility. The current design uses decentralised and permissionless sequencers and provers. The zkEVM circuits are based on the Ethereum Foundation's Privacy and Scaling Group research work on ZK-EVMs.
labels:
    - ZK-Rollup
    - EVM
    - Testnet
...
<Section title="Overview">
    ...
    Taiko is a decentralized ZK-Rollup that is still in development. The protocol targets Type 1 EVM compatibility. The current design uses decentralised and permissionless sequencers and provers. The zkEVM circuits are based on the Ethereum Foundation's Privacy and Scaling Group research work on ZK-EVMs.
