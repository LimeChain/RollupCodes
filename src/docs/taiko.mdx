...
<Section title="General">
    ...
    <Parameter name="Finality" value="~4 minutes" tooltip="The average time it takes for validity proof of an L2 block to be generated and submitted after it is sequenced on L1." />
