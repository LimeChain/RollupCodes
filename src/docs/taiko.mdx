...
<Section title="Overview">
    ...
    <Labels labels={['ZK-Rollup', 'EVM', 'Mainnet']} title="Taiko" />
...
<Section title="General">
    ...
    <Parameter name="Gas Limit" value="240,250,000" tooltip="The gas limit that can be consumed by an L2 block. 180 000 gas is reserved for the anchor transaction."/>
    ...
    <Parameter name="Objective Finality" value="~1.5 minutes" tooltip="The time it takes for a validity proof of an L2 block to be generated and submitted after it is sequenced on L1." />
