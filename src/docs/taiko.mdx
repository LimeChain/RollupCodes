...
<Section title="General">
    ...
    <Parameter name="Block Time" value="Any" tooltip="The rate at which the rollup produces blocks. Keep in mind that the value is subject to change in the future"/>
    ...
    <Parameter name="Node Implementations" value={<Reference label="taiko-geth" url="https://github.com/taikoxyz/taiko-geth" />} tooltip="The different client implementations of the Rollup" />
