---
title: Taiko
subtitle: Taiko is a Based Contestable Rollup that aims to be maximally compatible with Ethereum. At the moment, the protocol uses SGX proofs and doesn't allow Ethereum block builders to sequence transactions.
labels:
    - Optimistic Rollup
    - EVM
    - Mainnet
