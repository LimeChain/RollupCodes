---
title: Metis
subtitle: Metis is an EVM-compatible Optimistic Rollup. The protocol team centrally operates the sequencer. Transaction data is recorded off-chain in MEMO from Memo Labs.
labels:
    - Optimistic Rollup
    - OVM
    - Mainnet
...
<Section title="Overview">
    ...
    Metis is an EVM-compatible Optimistic Rollup. The protocol team centrally operates the sequencer. Transaction data is recorded off-chain in MEMO from Memo Labs.
...
<Section title="General">
    ...
    <Parameter name="Transaction Types" tooltip="The types of transactions supported on the Rollup" />
        ...
        - **Type 1** - User Transaction. A compressed EIP155 transaction that uses an alternative signature hashing algorithm.
    ___
