...
<Section title="OPCODEs">
    ...
    | 44 | DIFFICULTY | `block.difficulty` and `block.prevrandao` | Returns the constant `1` | Returns the output of the randomness beacon provided by the beacon chain <Modified /> |
