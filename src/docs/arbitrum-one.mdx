...
<Section title="RPC-API">
    ...
    | ![link icon](../images/link-icon.png) | `eth_getBlockByHash` | Hash of a block | Returns information for a given block.<br /><br />Adds additional information such as l1 block number, send count and send root. | Returns information for a given block. <Modified /> |
    | ![link icon](../images/link-icon.png) | `eth_getBlockByNumber` | Integer of a block number, or the string "earliest", "latest" or "pending” | Returns information for a given block.<br /><br />Adds additional information such as l1 block number, send count and send root. | Returns information for a given block. <Modified /> |
