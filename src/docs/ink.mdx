...
<Section title="Overview">
   Ink is an Optimistic Rollup utilizing OP Stack technology. The protocol features a centralised sequencer operated by the Ink team.
    ...
    - Scale up DeFi's user base and evolve the quality and range of DeFi products
...
<Section title="General">
    ...
    <Parameter name="Sequencing Frequency" value="6 hours" tooltip="The frequency at which the rollup posts L2 transactions on Ethereum L1. The time varies based on the amount of calldata that must be posted on L1" />
