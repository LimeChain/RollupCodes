...
<Section title="OPCODEs">
    ...
    | :----- | :--- | :-------------------| :--------------- | :-------------------- |
    | 40 | BLOCKHASH | `block.blockhash` | Returns keccak(chain_id [concatenated with] block_number) for the last 256 blocks. | Get the L1 block hash fro block number <Modified /> |
