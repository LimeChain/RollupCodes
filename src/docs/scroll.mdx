...
<Section title="System Contracts">
    ...
    | <Copy value="0xa13BAF47339d63B743e7Da8741db5456DAc1E556" label="0xa13...56" /> | <Reference label="L1 Rollup (Scroll Chain)" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L1/rollup/ScrollChain.sol" /> | The main contract of the Scroll Rollup. Contains the L2 state roots. It handles sequencing and finalisation of L2 blocks. | N/A <Added /> |
    | <Copy value="0x8432728A257646449245558B8b7Dbe51A16c7a4D" label="0x843...4D" /> | <Reference label="L1 System Config" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L1/system-contract/SystemConfig.sol" /> | The main contract of the Scroll Rollup. Contains the L2 state roots. It handles sequencing and finalisation of L2 blocks. | N/A <Added /> |
    | <Copy value="0x6774Bcbd5ceCeF1336b5300fb5186a12DDD8b367" label="0x677...67" /> | <Reference label="L1 Messenger" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L1/L1ScrollMessenger.sol" /> | Provides functionality for sending messages from L1 to L2 and claiming L2 to L1 messages. | N/A <Added /> |
    | <Copy value="0x56971da63A3C0205184FEF096E9ddFc7A8C2D18a" label="0x569...8a" /> | <Reference label="L1 Message Queue (V2)" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L1/rollup/L1MessageQueueV2.sol" /> | L1 message queue on Ethereum, holds all L1 to L2 messages (after the Euclid upgrade phase-2). | N/A <Added /> |
    | <Copy value="0x5300000000000000000000000000000000000000" label="0x530...00" /> | <Reference label="L2 MessageQueue" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L2/predeploys/L2MessageQueue.sol" /> | L2 message queue on Scroll, holds all L2 to L1 messages. | N/A <Added /> |
    | <Copy value="0x5300000000000000000000000000000000000002" label="0x530...02" /> | <Reference label="L1 Gas Price Oracle" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L2/predeploys/L1GasPriceOracle.sol" /> | L1 gas price oracle on Scroll. | N/A <Added /> |
    | <Copy value="0x5300000000000000000000000000000000000005" label="0x530...05" /> | <Reference label="L2 Fee Vault" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L2/predeploys/L2TxFeeVault.sol" /> | L2 Fee Vault on Scroll. | N/A <Added /> |
    | <Copy value="0x781e90f1c8Fc4611c9b7497C3B47F99Ef6969CbC" label="0x781...bC" /> | <Reference label="L2 Messenger" url="https://github.com/scroll-tech/scroll-contracts/blob/main/src/L2/L2ScrollMessenger.sol" /> | Provides functionality for sending messages from L2 to L1 and claiming L1 to L2 messages. | N/A <Added /> |
