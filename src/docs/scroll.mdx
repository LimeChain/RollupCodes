...
<Section title="Transaction Fees">
    ...
    The L1 calldata fee (aka L1 data fee) is deducted directly from the sender’s balance before a transaction’s execution, not paid for using gas. If you need to, you can use the predeployed [L1GasOracle](https://blockscout.scroll.io/address/0x5300000000000000000000000000000000000002) to get an estimate of the L1 fee that will be applied for a given transaction.
