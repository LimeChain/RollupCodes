---
title: Zircuit
subtitle: Zircuit is an EVM-compatible zero-knowledge rollup with a unique hybrid architecture that combines the battle-tested OP stack infrastructure with zero-knowledge proofs
labels:
    - ZK-Rollup
    - EVM
    - Mainnet
...
<Section title="Overview">
   Zircuit is an EVM-compatible zero-knowledge rollup with a unique hybrid architecture that combines the battle-tested OP stack infrastructure with zero-knowledge proofs
