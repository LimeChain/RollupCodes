...
import { getOptimismFinalizationData } from '@lib/server/services/optimismViemService'
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        console.error('[api/withdrawal/finalization-data]', error)
        return res.status(500).json({
            error: 'Failed to get finalization data'
        })
    }
}
